...
const corsOrigins = [
  ...
  'https://baconfort.web.app' // Firebase Hosting URL - Dominio principal
];
...
// Email transporter configuration - MEJORADO
let emailTransporter = null;

const setupEmailTransporter = () => {
  if (!process.env.EMAIL_USER || !process.env.EMAIL_APP_PASSWORD) {
    console.log('📧 Email credentials not provided - continuing without email features');
    return;
  }
  ...
  try {
    ...
    emailTransporter.verify((error, success) => {
      if (error) {
        console.log('📧 Email service currently unavailable - app continues normally');
        console.log('💡 To enable email: Check Gmail App Password configuration');
    ...
    console.log('📧 Email setup incomplete - app continues without email features');
    emailTransporter = null;
  }
};
